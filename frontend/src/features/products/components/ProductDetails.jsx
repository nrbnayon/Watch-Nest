...
export const ProductDetails = () => {
  ...
  console.log(handleBack, handleNext, activeStep, maxSteps);
        ...
        >
          {(productFetchStatus || reviewFetchStatus) === "pending" ? (
            ...
            <Stack>
              {/* product details */}
              <Stack
                width={is480 ? "auto" : is1420 ? "auto" : "90rem"}
                p={is480 ? 2 : 0}
              ...
              >
                ...
                >
                  {/* selected image / mobile swiper */}
                  <Stack mt={is480 ? "0rem" : "1rem"}>
                    {is1420 ? (
                      <Stack width={is480 ? "100%" : is990 ? "500px" : "500px"}>
                        <Swiper
                          ...
                          onSlideChange={(swiper) => {
                            ...
                            handleStepChange(swiper.realIndex);
                          }}
                      ...
                      <Box
                        sx={{
                          width: is480 ? "100%" : is990 ? "500px" : "500px",
                          aspectRatio: "1/1",
                          position: "relative",
                          backgroundColor: "#f5f5f5",
                          borderRadius: "8px",
